...
# # ######## TESTEO ##
# # ##################
pend1 = session.run(pendiente_1, feed_dict={puntosXY: x_y_values})
pend2 = session.run(pendiente_2, feed_dict={puntosXY: x_y_values})
ord1 = session.run(ordenada_1, feed_dict={puntosXY: x_y_values})
ord2 = session.run(ordenada_2, feed_dict={puntosXY: x_y_values})
